...
import com.portfolio.diaz.Dto.dtoEducacion;
import com.portfolio.diaz.Security.Controller.Mensaje;
import com.portfolio.diaz.entity.Educacion;
import com.portfolio.diaz.service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(),dtoeducacion.getPeriodoE()
            );
